...
namespace nodejs
{
  ...
  EnHybridDistance::Init(v8::Local<v8::Object> exports)
  {
    ...
    tpl->InstanceTemplate()->SetAccessor(
        v8::String::NewFromUtf8(isolate, "phoneticWeightPercentage").ToLocalChecked(),
        getphoneticWeightPercentage,
        setThrow);
    ...
    exports->Set(
        context,
        v8::String::NewFromUtf8(isolate, "EnHybridDistance").ToLocalChecked(),
